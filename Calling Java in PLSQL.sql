...
EXEC dbms_java.grant_permission('SHRI', 'SYS:java.lang.RuntimePermission', 'writeFileDescriptor', '');
EXEC dbms_java.grant_permission('SHRI', 'SYS:java.lang.RuntimePermission', 'readFileDescriptor', '');
EXEC dbms_java.grant_permission('SHRI', 'SYS:java.io.FilePermission', '/bin/sh', 'execute');
EXEC dbms_java.grant_permission( 'SHRI', 'SYS:java.io.FilePermission','C:\winnt\system32\cmd.exe', 'execute' )
